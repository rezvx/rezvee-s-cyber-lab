import { Network, Shield, Wrench, Monitor, FileText } from "lucide-react";
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <SectionHeader
            ...
            title="My"
            highlight="Expertise"
            description="Comprehensive skill set in networking, cybersecurity, and technical documentation"
          />
